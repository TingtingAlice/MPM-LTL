...
def save_images(zip_file, save_dir=None, train_test_split_file=None):
 ...
 # with ZipFile(zip_file) as z:
  ...
  nums.append(len(im_paths_))
  print('len of im_paths:'+str(len(im_paths)))
  print("the first image "+im_paths[0])
  print("the last image "+im_paths[-1])
  print(new_im_dir)
  im_names = move_ims(
    im_paths, new_im_dir, parse_original_im_name, new_im_name_tmpl)
  print("thr first image "+im_names[0])
  print("the last image "+im_names[-1])
  split = dict()
...
if __name__ == '__main__':
  ...
  parser.add_argument('--zip_file', type=str,
                      default='/mnt/data/dataset/pcb/Market-1501-v15.09.15.zip')
  parser.add_argument('--save_dir', type=str,
                      default='/mnt/data/dataset/pcb/market1501png')
