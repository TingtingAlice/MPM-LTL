...
from bpm.utils.dataset_utils import anchor_positive_negative_2_2
...
def save_images(original_file, save_dir=None, train_test_split_file=None):
  ...
  anchor_positive_negative_2_2(im_paths, parse_original_im_name, save_dir)
...
def transform(original_file, save_dir=None):
  ...
  partition_file = osp.join(save_dir, 'new_shuffle_apn_partitions_2_2.pkl')
