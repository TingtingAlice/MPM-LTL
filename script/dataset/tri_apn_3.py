...
from bpm.utils.dataset_utils import anchor_positive_negative_3
...
def save_images(dataset, original_file, save_dir=None, train_test_split_file=None):
  ...
  anchor_positive_negative_3(dataset, im_paths, parse_original_im_name, save_dir)
...
def transform(dataset, original_file, save_dir=None):
  ...
  train_test_split = save_images(dataset, original_file, save_dir, train_test_split_file)
  ...
  partition_file = osp.join(save_dir, 'new_shuffle_apn_partitions_3.pkl')
...
if __name__ == '__main__':
  ...
  transform(dataset, original_file, save_dir)
