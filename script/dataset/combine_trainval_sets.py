...
if __name__ == '__main__':
  ...
  parser.add_argument(
    '--market1501_im_dir',
    type=str,
    default=ospeu('/mnt/data/dataset/market1501/images')
  )
  parser.add_argument(
    '--market1501_partition_file',
    type=str,
    default=ospeu('/mnt/data/dataset/market1501/partitions.pkl')
  )
  ...
  parser.add_argument(
    ...
    default=ospeu('/mnt/data/dataset/cuhk03/{}/images'.format(cuhk03_im_type))
  )
  parser.add_argument(
    '--cuhk03_partition_file',
    type=str,
    # Remember to select the detected or labeled set.
    default=ospeu('/mnt/data/dataset/cuhk03/{}/partitions.pkl'.format(cuhk03_im_type))
  )

  parser.add_argument(
    '--duke_im_dir',
    type=str,
    default=ospeu('/mnt/data/dataset/duke/images'))
  parser.add_argument(
    '--duke_partition_file',
    type=str,
    default=ospeu('/mnt/data/dataset/duke/partitions.pkl')
  )

  parser.add_argument(
    '--save_dir',
    type=str,
    default=ospeu('/mnt/data/dataset/pcb/market1501_cuhk03_duke')
  )
