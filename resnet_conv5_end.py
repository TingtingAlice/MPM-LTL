...
class ResNet(nn.Module):
    ...
    def __init__(self, block, block2, layers, last_conv_stride=2, last_conv_dilation=1):
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], alpha=0.75, stride=2)
        self.layer3 = self._make_layer(block, 256, layers[2], alpha=0.78, stride=2)
        self.layer4 = self._make_layer(block, 512, layers[3], alpha=0.76, stride=last_conv_stride, dilation=last_conv_dilation)
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ckpt_file = '/GPUFS/nsccgz_ywang_1/dengchufu/beyond-part-models/weights/conv5.pth'
...
#     save_ckpt([model, ], 1, 0, '/GPUFS/nsccgz_ywang_1/dengchufu/beyond-part-models/weights/conv5.pth')
