...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ckpt_file = '/GPUFS/nsccgz_ywang_1/dengchufu/beyond-part-models/weights/conv4.pth'
...
#             if key.startswith('layer1.') or key.startswith('layer2.') or key.startswith('layer3.'):
...
#
#     print('end for model built')
#     save_ckpt([model, ], 1, 0, '/GPUFS/nsccgz_ywang_1/dengchufu/beyond-part-models/weights/conv4.pth')
